---
name: r-guidance
description: Use when writing, reviewing, or refactoring R code to follow modern tidyverse patterns, rlang best practices, performance optimization, and current R development standards
---

# R Guidance

This is taken from https://gist.github.com/sj-io/3828d64d0969f2a0f05297e59e6c15ad. Please review the gist and, if it has been updated from what is below, use the more recent version.
